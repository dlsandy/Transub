    ...
    const CANONICAL_INTENT_DEFS = Object.freeze([
        {
            ...
            note: 'Strip invented T.meatRodZh when JA has no rod cue (any title)',
        },
        {
            ...
            jaRequireHint: 'clinical ZH (T.maleGenitalZh / T.penisZh / T.bigSizeZh…) or dekachin JA',
            pairedWith: Object.freeze(['strip.meatRod.hallucination']),
            fixtureRefs: Object.freeze([
                'keeps clinical rod remaps without reopening ADN-798 hallucination strip',
                'MIDA-762: male-genital / dekachin-size / kintama-epididymis / porchio',
                'batch-engine-0820eve: okyaku rod/insert + genki/tachi + like-iku skip + touch mitete',
                'batch-engine-0820abf2: uni irete skip + rod tsuite/shabu + naka itta + name order',
                'batch-engine-0821roe: rod arigatou/mamire/shiranai + iyarashii dashite + mouth irete',
                'batch-engine-0821jukf: rod cluster + iku/irete/dashite skip + sensei/rame under',
                'batch-engine-0821noon: rod aishi/torotoro/shiko + choudai tsuba + iku skip/nip',
                'batch-engine-0821pm: juzran→meatRod + sensei irete + fellason + skip 反省/パズル',
                'batch-engine-0821eve: rod nigitte/shaburi + iku skip itchan + rame 玲香 + manko shaburi',
                'batch-engine-0821night: rod nioi/dekachi + skip 気負い出/開き出 + sensei penis ejac + nip hasamu',
                'batch-engine-0821late: rod pikupiku/dashichatta + skip サイクル/抜け出して + lick while + irete dame',
            ]),
            flags: Object.freeze(['domain_term']),
            note: 'Clinical / euphemism ZH → colloquial T.meatRodZh must survive strip (any title)',
        },
        {
            ...
            flags: Object.freeze(['domain_hallucination']),
            note: 'Strip invented T.rodZh/棒 when JA has no rod cue (any title)',
        },
        {
            ...
            smokeTitles: Object.freeze(['MIDA-762']),
            jaRequireHint: 'ZH contains clinical T.maleGenitalZh / 生殖器 (remap to colloquial)',
            pairedWith: Object.freeze(['strip.meatRod.hallucination']),
            fixtureRefs: Object.freeze([
                'MIDA-762: male-genital / dekachin-size / kintama-epididymis / porchio',
            ]),
            flags: Object.freeze(['domain_term']),
            note: 'T.maleGenitalZh line → T.meatRodZh colloquial (pattern, not film-scoped)',
        },
        {
            id: 'recover.blankIku',
            kind: KIND.recover,
            ...
            pairedWith: Object.freeze(['remap.femaleManko.toGo', 'strip.itchan.falseClimax']),
            fixtureRefs: Object.freeze([
                'ADN-798/791 + residuals: milk ASR / nakadashi / sefri / iku-start / blanks',
                'batch-engine-0820: rod kudasai/boku/zako + touch-iku + いっちゃん strip + 腰入れ skip',
                'batch-engine-0820abf: face-uta ASR + manko-sei + iku-buxing + lick/irete/rod',
            ]),
            flags: Object.freeze(['blank_adult_recover']),
            note: 'Blank ZH + iku JA → recover T.aboutToCumZh (not a strip; any title)',
        },
        {
            ...
            jaRequireHint: 'T.mankoHiraJa/T.nippleJa/らめ/ダメイッ female climax cues — prefer T.aboutToGoZh not shoot/cum forms',
            pairedWith: Object.freeze(['recover.blankIku']),
            fixtureRefs: Object.freeze([
                'batch-0811night: latin scrap widen + manko climax + hard-rod stub',
                'batch-engine-0812night: show/fella/キス/らめぇ stubs',
                'batch-engine-0813: soft_go / yame_shoot polarity (らめイク / ダメイッちゃった / やめろ)',
            ]),
            flags: Object.freeze(['domain_term', 'blank_adult_recover']),
            note: 'Female manko/nipple/らめ/ダメ climax → T.aboutToGoZh; must not be forced to male T.aboutToCumZh',
        },
        {
            ...
            flags: Object.freeze(['domain_term']),
            note: 'Male 出してくれ climax → T.aboutToCumZh; opposite of female soft_go',
        },
        {
        ...
        },
        {
            ...
            jaRequireHint: 'T.ochinchinJa/T.chinpoHiraJa JA — T.yangwuZh soft gloss → T.meatRodZh',
            pairedWith: Object.freeze(['strip.meatRod.hallucination']),
            fixtureRefs: Object.freeze([
                'batch-engine-0813b: under soft-cover tip/rod/dashite/iku/choudai',
                'keeps clinical rod remaps without reopening ADN-798 hallucination strip',
            ...
            flags: Object.freeze(['domain_term']),
            note: 'T.yangwuZh → T.meatRodZh; still paired with hallucination strip',
        },
        {
            ...
            jaRequireHint: 'ZH moan stub 哈 哈/嗯嗯/呵呵 or glued T.smallHoleZh哈 哈 + lexical JA; strip はぁはぁ/ふふふ prefix',
        ...
        },
        {
            ...
            jaForbidHint: 'パンパン swollen/slap JA must not invent T.jiJiZh/T.meatRodZh',
            pairedWith: Object.freeze(['remap.clinicalRod.toMeatRod']),
            fixtureRefs: Object.freeze([
                'batch-engine-0812late: FNS/DVAJ teacher stubs, ディル, sov/feira',
            ]),
            flags: Object.freeze(['domain_hallucination']),
            note: 'パンパン ≠ rod invent; strip T.jiJiZh棒棒 / unjustified T.meatRodZh',
        },
        {
            id: 'remap.manko.fingerInsert',
            kind: KIND.remap,
            layer: LAYER.opaque,
            reusable: true,
            zhRef: 'T.pussyZh',
            smokeTitles: Object.freeze(['MIDA-746']),
            jaRequireHint: 'おT.mankoHiraJaに指入れ — finger, not rod',
            pairedWith: Object.freeze(['remap.clinicalRod.toMeatRod']),
            fixtureRefs: Object.freeze([
                'batch-engine-0819noon: rod milk/janakute + manko finger vs kitchen + skip いっちゃん/突き出し',
            ]),
            flags: Object.freeze(['domain_term']),
            note: '指入れ must keep T.smallHoleZh and must not invent T.meatRodZh (kitchen path)',
        },
        {
            id: 'strip.itchan.falseClimax',
            kind: KIND.strip,
            layer: LAYER.opaque,
            reusable: true,
            zhRef: 'T.aboutToCumZh',
            smokeTitles: Object.freeze(['DVAJ-746']),
            jaForbidHint: 'いっちゃん nickname + ダメに決まっ — not climax',
            pairedWith: Object.freeze(['remap.maleAshitaDashite.toShoot', 'recover.blankIku']),
            fixtureRefs: Object.freeze([
                'batch-engine-0820: rod kudasai/boku/zako + touch-iku + いっちゃん strip + 腰入れ skip',
                'batch-engine-0820eve: okyaku rod/insert + genki/tachi + like-iku skip + touch mitete',
                'batch-engine-0820abf: face-uta ASR + manko-sei + iku-buxing + lick/irete/rod',
            ...
            flags: Object.freeze(['domain_hallucination']),
            note: 'Strip false T.aboutToCumZh/T.aboutToGoZh on nickname いっちゃん without real イク cue',
        },
        {
            id: 'strip.koshiIre.inventInsert',
            kind: KIND.strip,
            layer: LAYER.opaque,
            reusable: true,
            zhRef: null,
            zhLiteral: '插进去',
            smokeTitles: Object.freeze(['DVAJ-746']),
            jaForbidHint: '腰入れ hip coaching without rod/manko',
            pairedWith: Object.freeze(['remap.clinicalRod.toMeatRod']),
            fixtureRefs: Object.freeze([
                'batch-engine-0820: rod kudasai/boku/zako + touch-iku + いっちゃん strip + 腰入れ skip',
                'batch-engine-0820abf2: uni irete skip + rod tsuite/shabu + naka itta + name order',
            ...
            flags: Object.freeze(['domain_hallucination']),
            note: '腰入れ must not invent 插进去; real T.ochinpoJa入れて keeps insert',
        },
    ]);
